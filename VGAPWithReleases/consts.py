...
SINGLE_DIMENTTION_GREEDY_VGAPWD = "SingleDimentionGreedyVGAPWD"
OPT_NAME = "OPT"

ALGS_NAMES = [GREEDY_VGAPWD_NAME, SINGLE_DIMENTTION_GREEDY_VGAPWD, VGAPWD_NAME, VMKPSD_NAME, VMKPSDWH_NAME, BEST_FIT_NAME, FIRST_FIT_NAME,
